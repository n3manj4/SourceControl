...
CREATE TABLE [Person].[Address] (
		...
		[asdfs]               [nchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
EXEC sp_addextendedproperty N'MS_Descriptionnnnn', N'Clustered index created by a primary key constraint.', 'SCHEMA', N'Person', 'TABLE', N'Address', 'INDEX', N'PK_Address_AddressID'
GO
