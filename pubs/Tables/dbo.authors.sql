...
ALTER TABLE [dbo].[authors]
	ADD
	CONSTRAINT [CK__authors__au_id__36B12243]
	CHECK
	([au_id] like '[0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9][0-9][0-9]')
GO
ALTER TABLE [dbo].[authors]
CHECK CONSTRAINT [CK__authors__au_id__36B12243]
GO
ALTER TABLE [dbo].[authors]
	ADD
	CONSTRAINT [CK__authors__zip__38996AB5]
	CHECK
	([zip] like '[0-9][0-9][0-9][0-9][0-9]')
GO
ALTER TABLE [dbo].[authors]
CHECK CONSTRAINT [CK__authors__zip__38996AB5]
GO
ALTER TABLE [dbo].[authors]
	ADD
	CONSTRAINT [DF__authors__phone__37A5467C]
