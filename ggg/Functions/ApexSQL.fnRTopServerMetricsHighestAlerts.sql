...
-- Description:	Top 10 SQL Server metrics with highest number of alerts
-- =============================================
CREATE FUNCTION [ApexSQL].[fnRTopServerMetricsHighestAlerts]
(
...
(
	...
	(
		...
		WHERE SourceId IN (SELECT SourceId FROM [ApexSQL].[fnRGetAllSourcesInsideServer](@SourceId))
